...
static inline const char *drm_get_color_encoding_name(unsigned int v)  { return "?"; }
static inline const char *drm_get_color_range_name(unsigned int v)     { return "?"; }
inline const char *drm_get_colorspace_name(enum drm_colorspace colorspace)      { return "?"; }
